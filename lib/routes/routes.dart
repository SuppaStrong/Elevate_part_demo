...
import 'package:elevate_ecommerce/views/order_default_details/order_default_details_screen.dart';
import 'package:elevate_ecommerce/views/order_delivery_details/order_delivery_details_screen.dart';
...
class Routes {
  ...
  static final routes = [
    ...
    GetPage(
      name: '/oderDefault',
      page: () => const OrderDefaultDetailsScreen(),
      bindings: const [
    ...
    GetPage(
      name: '/oderDelivery',
      page: () => const OrderDeliveryDetailsScreen(),
      bindings: const [
